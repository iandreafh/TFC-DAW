...
import DatosEmpleados from './DatosEmpleados.js';
import DatosPacientes from './DatosPacientes.js';
  ...
  render() {
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light border-bottom" style={{ height: '3em'}}>
            <button className="btn btn-dark mt-0" id="menu-toggle" onClick={this.handleClick} style={{ width: '2em', height: '2em', padding: '0', paddingBottom: '4px'}}><img id="flecha" src={flechaClose} width="20" /></button>
